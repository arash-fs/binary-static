...
const ChangePassword = (() => {
    ...
    const init = () => {
        FormManager.init(form_id, [
            ...
            { selector: '#new_password',    validations: ['req', ['length', { min: 8, max: 25 }],'password', ['not_equal', { to: '#old_password', name1: localize('Current password'), name2: localize('New password') }], 'compare_to_email'], re_check_field: '#repeat_password' },
